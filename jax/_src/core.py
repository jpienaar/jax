...
def new_jaxpr_eqn(invars, outvars, primitive, params, effects, source_info=None,
  ...
  print("Debug: new jaxpr eqn: thread local attributes: ", thread_local_attributes)
  print("Debug: new jaxpr eqn: thread local attributes val: ", thread_local_attributes.val)
